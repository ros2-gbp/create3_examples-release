...
Name:           ros-humble-create3-coverage
Version:        0.0.5
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS create3_coverage package

License:        BSD
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-create3-examples-msgs
...
BuildRequires:  ros-humble-create3-examples-msgs
